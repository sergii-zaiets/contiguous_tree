...
TEST(Classical_tree, root_with_2_children) {
  contiguous::Tree<int> tree(5);
...
TEST(Classical_tree, test_for_each___create_in_depth_with_d_3_w_2) {
  int depth = 3;
  int width = 2;
...
TEST(Classical_tree, test_for_each___create_in_width_with_d_3_w_2) {
  int depth = 3;
  int width = 2;
